...
model_params = {
    ...
    'batch_size': 64,
    'num_epochs': 3,
    'logdir': './EXPERIMENT_3/logs/model_10',
    'print_every': 1,
    'save_every': 5,
    ...
    'embedding_params': {
        ...
        'embedding_dim': 512, # default: 128
        'padding_idx': train_dataset.tokens.index(' ')
    },
    'encoder': RNNEncoder,
    'encoder_params': {
        'input_size': 512, # default: 128
        'layer': "LSTM", # default LSTM
        'encoder_dim': 512, # default: 128
        'n_layers': 4, # default 4
        'dropout': 0.6, # default: 0.8                  best: 0.4 + mlp_dropout 0.4
    ...
    'mlp_params': {
        ...
        'hidden_size': [512, 12], # default [128, 12]
