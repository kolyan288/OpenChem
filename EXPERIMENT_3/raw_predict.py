...
class MyModel:
    def __init__(self, model_number):
        ...
        self.config_file = rf'EXPERIMENT_3/configs/tox21_rnn_config_{self.model_number}.py'
        ...
        self.model.module.load_state_dict(torch.load(rf'EXPERIMENT_3/model_OpenChem_CLASSIFIER_ENSEMBLE_{self.model_number}.pth'))
