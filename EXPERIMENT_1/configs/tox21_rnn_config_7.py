...
model_params = {
    ...
    'batch_size': 64,
    'num_epochs': 21,
    'logdir': './EXPERIMENT_1/logs/model_7',
    'print_every': 1,
    'save_every': 5,
    ...
    'encoder_params': {
        ...
        'encoder_dim': 64, # default: 128
        'n_layers': 3, # default 4
        'dropout': 0.5, # default: 0.8                  best: 0.4 + mlp_dropout 0.4
